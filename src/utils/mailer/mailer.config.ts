...
//   childCreate: {
//     subject: `NodeExpressTypeSriptStarterKit: Welcome to [nurseryName] `,
...
//   },
  ...
  reset: {
    ...
    message({ firstName, lastName, email, shortLink }) {
              ...
              <table class="responsiveTd" style="height:auto; padding-top: 20px;padding-bottom: 20px;padding-left: 90px; margin:0; display:block; max-width: 935px" >
                <tr class="remove-top-mob" style="padding-bottom:10px;">
                  <td>
                    ...
                    <p style="color:#767676; font-size: 24px; font-weight: 400;">
                        NodeExpressTypeSriptStarterKit Team
                    </p>
                  </td>
                </tr>
              </table>
      ...
      welcome: {
        subject: 'NodeExpressTypeSriptStarterKit: Welcome',
          ...
          <table class="responsiveTd" style="height:auto; padding-top: 20px;padding-bottom: 20px;padding-left: 90px; margin:0; display:block; max-width: 935px" >
            <tr class="remove-top-mob" style="padding-bottom:10px;">
              <td>
                ...
                <br><br>
                <p class="remove-top-mob" style="color:#767676; line-height: 28.8px; font-size: 24px; font-weight: 400;">
                    Welcome to NodeExpressTypeSriptStarterKit – your partner in early childhood education excellence!
                </p>
                <p class="remove-top-mob" style="color:#767676; line-height: 28.8px; font-size: 24px; font-weight: 400;">
                ...
                <p class="remove-top-mob" style="color:#767676; line-height: 28.8px; font-size: 24px; font-weight: 400;">
                    Excited to see your nursery thrive with NodeExpressTypeSriptStarterKit!
                </p>
                <br><br>
                <br><br>
                <p style="color:#767676; font-size: 24px; font-weight: 400;">
  ...
  //     },
  //     demoRequest: {
  //       subject: 'NodeExpressTypeSriptStarterKit: Demo Request',
  ...
  //                     <br>
  //                     <p class="remove-top-mob" style="color:#767676; line-height: 28.8px; font-size: 24px; font-weight: 400;">
  //                         Your demo request has been for NodeExpressTypeSriptStarterKit has been approved by our team.
  //                     </p>
  //                     <br>
  //                     <p style="color:#767676; line-height: 28.8px; font-size: 24px; font-weight: 400;">
  //                         Demo details:
